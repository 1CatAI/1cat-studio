    ...
    with tempfile.TemporaryDirectory(prefix="onecat-browser-") as state, (ARTIFACTS / "server.log").open("w") as log:
        ...
        try:
            ...
            with sync_playwright() as pw:
                ...
                expect(page.get_by_placeholder("自动：跟随模型")).to_have_value("")
                ...
                expect(page.get_by_role("dialog")).to_contain_text("工具调用可用")
                expect(page.get_by_role("dialog")).to_contain_text("图片理解可用")
